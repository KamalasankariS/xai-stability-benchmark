...
1) CIFAR-10	10,000	10	32×32 → 224×224	Upsampling + ImageNet head retained
2) ImageNet	40,000	1,000	Native	Subsampled validation set
3) MS-COCO	30,000	80	Native	Classification head adapted
